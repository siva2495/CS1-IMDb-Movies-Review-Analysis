# CS1-IMDb-Movies-Review-Analysis
...
## The following task which are going to help us get useful insights from the data.
•	Read and explore the data.

•	Data Analysis based attributes which creates major impact on data.

•	Demography Analysis.

## Libraries which I used for this analysis are
•	Numpy
•	Pandas
•	Seaborn
•	Matplotlib
...
let's start with some data manipulation, analysis, and visualisation to get various insights about the data.
...
3. Again do a similar analysis but with the ratings. Make a boxplot that shows how the ratings from the US people i.e. VotesUS is varying for the US and non-US movies. Similarly, make another subplot that shows how VotesnUS is varying for the US and non-US movies.
...
You can also try to relate it with the heatmaps you did in the previous subtasks.
